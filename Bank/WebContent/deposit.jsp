...
<body>
<% 
String un=(String)session.getAttribute("adminun");
if(un!=null)
{
	 
	RequestDispatcher rd=request.getRequestDispatcher("AdminHome.jsp");
	 
	out.println("<h3 align='center'> <br> <form action='dep.jsp' method='post'><pre>");
	out.println("First Name     <input type='text' name='fn'><br>");
	out.println("Mobile Number  <input type='text' name='mob'><br>");
